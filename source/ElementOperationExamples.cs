...
/// How to run:
/// - dotnet run .\source\ElementOperationExamples.cs
/// </summary>
...
public class Program
{
    public static void Main()
    {
        ...
        Console.WriteLine($"First:              {ElementOperationExamples.First(numbers)}");
        Console.WriteLine($"FirstOrDefault:     {ElementOperationExamples.FirstOrDefault(numbers)}");
        Console.WriteLine($"FirstEven:          {ElementOperationExamples.FirstEven(numbers)}");
        Console.WriteLine($"Last:               {ElementOperationExamples.Last(numbers)}");
        Console.WriteLine($"LastOrDefault:      {ElementOperationExamples.LastOrDefault(numbers)}");
        Console.WriteLine($"Single:             {ElementOperationExamples.Single(single)}");
        Console.WriteLine($"SingleOrDefault:    {ElementOperationExamples.SingleOrDefault(single)}");
        Console.WriteLine($"ElementAt(2):       {ElementOperationExamples.ElementAt(numbers, 2)}");
        Console.WriteLine($"ElementAtOrDefault: {ElementOperationExamples.ElementAtOrDefault(numbers, 10)}");
    }
}
