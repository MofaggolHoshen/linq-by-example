...
/// How to run:
/// - dotnet run .\source\QuantifierExamples.cs
/// </summary>
...
public class Program
{
    public static void Main()
    {
        ...
        Console.WriteLine($"HasEvenNumber:      {QuantifierExamples.HasEvenNumber(numbers)}");
        Console.WriteLine($"IsNonEmpty:         {QuantifierExamples.IsNonEmpty(numbers)}");
        Console.WriteLine($"AllPositive:        {QuantifierExamples.AllPositive(numbers)}");
        Console.WriteLine($"ContainsValue(3):   {QuantifierExamples.ContainsValue(numbers, 3)}");
        Console.WriteLine($"ContainsIgnoreCase: {QuantifierExamples.ContainsIgnoreCase(words, "APPLE")}");
    }
}
